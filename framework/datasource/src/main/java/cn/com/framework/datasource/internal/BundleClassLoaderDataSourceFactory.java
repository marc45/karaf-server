...
import cn.com.framework.datasource.BundleClassLoaderDataSource;
 ...
 */
public class BundleClassLoaderDataSourceFactory implements ObjectFactory {

    private static final Log log = LogFactory.getLog(BundleClassLoaderDataSourceFactory.class);
    ...
    public static BasicDataSource createDataSource(Properties properties) throws Exception {
        BasicDataSource dataSource = new BundleClassLoaderDataSource();
        String value = null;
